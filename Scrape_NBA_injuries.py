...
driver = webdriver.Chrome(executable_path = "C:/Users/djgra/OneDrive/R/SportsBetting/chromedriver.exe")
...
def injuries(team):
    ...
    for i in range(len(Injuries)):
        if Injuries.Team[i] ==team:
            print(Injuries.loc[i,'Player'], "is", Injuries.loc[i,'Status'], Injuries.loc[i,'Return date']," with news date", Injuries.loc[i,'News date'])
